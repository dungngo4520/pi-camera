...
TEST(kelvin_to_gains_always_positive_and_bounded) {
    ...
    for (int k : {1000, 1500, 1900, 2000, 2500, 3000, 4000, 5000,
                  5500, 6500, 6600, 8000, 10000, 20000, 50000}) {
        float r = -1, b = -1;
        kelvinToGains(k, r, b);
        CHECK(r >= 0.1f);
        CHECK(r <= 8.0f);
