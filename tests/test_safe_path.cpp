...
TEST(safe_path_component_rejects_empty) { CHECK(!isSafePathComponent("")); }
...
TEST(safe_capture_path_builds_correctly) {
  std::string path =
      safeCapturePath("/home/pi/captures", "shot", "20240101-120000", "jpg");
...
TEST(safe_file_path_rejects_empty) { CHECK(!isSafeFilePath("")); }
...
TEST(canonicalize_dir_rejects_empty) { CHECK(canonicalizeDir("").empty()); }
...
TEST(is_canonical_path_inside_valid) {
  CHECK(
      isCanonicalPathInside("/home/pi/captures/shot.jpg", "/home/pi/captures"));
  CHECK(isCanonicalPathInside("/home/pi/captures/sub/shot.jpg",
                              "/home/pi/captures"));
}
...
TEST(is_canonical_path_inside_rejects_traversal) {
  CHECK(!isCanonicalPathInside("/home/pi/captures/../etc/passwd",
                               "/home/pi/captures"));
}
